...
<!--                &lt;!&ndash;                  <a class="button is-primary">&ndash;&gt;-->
<!--                &lt;!&ndash;                    <strong>Sign up</strong>&ndash;&gt;-->
<!--                &lt;!&ndash;                  </a>&ndash;&gt;-->
<!--                &lt;!&ndash;                  <a class="button is-light">&ndash;&gt;-->
<!--                &lt;!&ndash;                    Log in&ndash;&gt;-->
<!--                &lt;!&ndash;                  </a>&ndash;&gt;-->
<!--                &lt;!&ndash;                </div>&ndash;&gt;-->
...
<!--        </nav>-->
        ...
        <a-row :gutter="16">
          ...
          <a-col :lg="8" :xs="7">
            <AsideBox type="search"
                      @some-search="search1Callback"
                      v-model:search-value="search1Value"
            ></AsideBox>

<!--            {{searchValue}}-->
<!--            <AsideBox type="search"-->
<!--                      @some-search="search2Callback"-->
<!--                      v-model:search-value="search2Value"-->
<!--            ></AsideBox>-->
            <AsideBox type="news" name="最新的文章" :newsData="newsData" ></AsideBox>
<!--            <AsideBox type="news" name="最新文章" :newsData="newsDataComp"></AsideBox>-->
...
const tagsData = [{name:'真牛',color:'#87d068'},{name:'大神',color:'#22d068'}]
